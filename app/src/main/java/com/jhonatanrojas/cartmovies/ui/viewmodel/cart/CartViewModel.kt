...
class CartViewModel @Inject constructor(private val getCartMoviesUseCase: GetMoviesCartUseCase ) : ViewModel() {


    private val compositeDisposable = CompositeDisposable()
    var cartMovies: SingleLiveData<List<CartMovie>> = SingleLiveData()
